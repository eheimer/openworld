...
/**
 * Active condition instance attached to a character.
 *
 * The **affected entity** (who has this condition) is identified by
 * `characterId`. This is the ownership column — the character that is
 * currently experiencing the effect.
 *
...
export class CharacterCondition extends BaseEntity {
  ...
  /** The character affected by this condition — the ownership column. */
  @Column()
  characterId!: number;
